...
load = r'''    def load(self, filename: str | Path) -> list[ArrivalItem]:
        ...
        magina_header = "\u0413\u0435\u043b\u044c \u043a\u043e\u043d\u0434\u0438\u0446\u0438\u043e\u043d\u0435\u0440 1400 MAGINA"
        elegant_header = "SVO 1500 ELEGANT WHITE"
...
p.write_text(prefix + load, encoding="utf-8")
print("SALES LOAD REBUILT WITH SAFE UNICODE")
